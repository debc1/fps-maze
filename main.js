...
class FirstPersonCamera {
  ...
  updateCamera_(_) {
    ...
    this.camera_.position.y += Math.sin(this.headBobTimer_ * 10) * 0.35;
...
class FirstPersonCameraMaze {
  ...
  initializeScene_() {
    ...
    const floor = mapLoader.load('resources/Tiles131_1K-JPG_Color.jpg');
    ...
    const roof = mapLoader.load('resources/PavingStones136_1K-JPG_Color.jpg');
    roof.anisotropy = maxAnisotropy;
    roof.wrapS = THREE.RepeatWrapping;
    roof.wrapT = THREE.RepeatWrapping;
    roof.repeat.set(8, 8);
    roof.encoding = THREE.sRGBEncoding;

    const plane = new THREE.Mesh(
        new THREE.PlaneGeometry(100, 100, 10, 10),
        new THREE.MeshStandardMaterial({map: floor}));
    ...
    const roof1 = new THREE.Mesh(
      ...
      new THREE.MeshStandardMaterial({map: roof}));
      roof1.position.set(10, 8, 0);
      roof1.castShadow = true;
      roof1.receiveShadow = true;
      this.scene_.add(roof1);

    const box = new THREE.Mesh(
    new THREE.BoxGeometry(40, 10, 1),
    this.loadMaterial_('cracking_painted_asphalt_', 2));
    ...
    const box2 = new THREE.Mesh(
      ...
      this.loadMaterial_('cracking_painted_asphalt_', 3));
    box2.position.set(10, 2, -20);
    ...
    const box3 = new THREE.Mesh(
      ...
      this.loadMaterial_('cracking_painted_asphalt_', 2.5));
    box3.position.set(12, 2, 20);
    ...
    const box4 = new THREE.Mesh(
      ...
      this.loadMaterial_('cracking_painted_asphalt_', 1.5));
    box4.position.set(-20, 2, 30);
    ...
    const box17 = new THREE.Mesh(
      new THREE.BoxGeometry(30, 10, 1),
      this.loadMaterial_('cracking_painted_asphalt_', 1.5));
    box17.position.set( 40, 2, 10);
    box17.castShadow = true;
    box16.receiveShadow = true;
    this.scene_.add(box17);

    const box18 = new THREE.Mesh(
      new THREE.BoxGeometry(4, 10, 4),
      this.loadMaterial_('cracking_painted_asphalt_', 1.5));
    box18.position.set( 20, 2, 10);
    box18.castShadow = true;
    box18.receiveShadow = true;
    this.scene_.add(box18);

    const box19 = new THREE.Mesh(
      new THREE.BoxGeometry(4, 10, 4),
      this.loadMaterial_('cracking_painted_asphalt_', 1.5));
    box19.position.set( 30, 2, 40);
    box19.castShadow = true;
    box19.receiveShadow = true;
    this.scene_.add(box19);

    const box20 = new THREE.Mesh(
      new THREE.BoxGeometry(1, 10, 30),
      this.loadMaterial_('cracking_painted_asphalt_', 1.5));
    box20.position.set(-30, 2, 40);
    box20.castShadow = true;
    box20.receiveShadow = true;
    this.scene_.add(box20);

    const box21 = new THREE.Mesh(
      new THREE.BoxGeometry( 4, 10, 4),
      this.loadMaterial_('cracking_painted_asphalt_', 1.5));
    box21.position.set(-20, 2, 0);
    box21.castShadow = true;
    box21.receiveShadow = true;
    this.scene_.add(box21);

    const box22 = new THREE.Mesh(
      new THREE.BoxGeometry( 4, 10, 4),
      this.loadMaterial_('cracking_painted_asphalt_', 1.5));
    box22.position.set(-40, 2, 30);
    box22.castShadow = true;
    box22.receiveShadow = true;
    this.scene_.add(box22);

    const box23 = new THREE.Mesh(
      new THREE.BoxGeometry( 4, 10, 4),
      this.loadMaterial_('cracking_painted_asphalt_', 1.5));
    box23.position.set(30, 2,-40);
    box23.castShadow = true;
    box23.receiveShadow = true;
    this.scene_.add(box23);

    const box24 = new THREE.Mesh(
      new THREE.BoxGeometry( 4, 10, 4),
      this.loadMaterial_('cracking_painted_asphalt_', 1.5));
    box24.position.set(-2, 2,-20);
    box24.castShadow = true;
    box24.receiveShadow = true;
    this.scene_.add(box24);


    const wall1 = new THREE.Mesh(
      new THREE.BoxGeometry(100, 100, 4),
      this.loadMaterial_('cracking_painted_asphalt_', 8));
    ...
    // Crosshair
    const crosshair = mapLoader.load('resources/dot.png');
...
window.addEventListener('DOMContentLoaded', () => {
  _APP = new FirstPersonCameraMaze();
});
